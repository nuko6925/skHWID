...
public class VelocityForce extends Effect {
	...
	protected void execute(Event arg0) {
		...
		player.setVelocity(attacker.getLocation().getDirection().setY(v).normalize().multiply(h));
		Bukkit.getScheduler().runTaskLater(Main.getInstance(), () -> player.setVelocity(attacker.getLocation().getDirection().setY(v).normalize().multiply(h)), 1l);
	}
