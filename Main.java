...
import net.sia.addon.elements.secure.Country;
...
public class Main extends JavaPlugin implements Listener {
	...
	public void onEnable() {
		...
		Skript.registerEffect(Exec.class, "[skHWID] (run|exec) process %string%");
		Skript.registerExpression(Filefinder.class, Boolean.class, ExpressionType.COMBINED, "[skHWID] file %string% finder");
